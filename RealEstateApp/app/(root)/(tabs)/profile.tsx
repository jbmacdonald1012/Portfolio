import {View, Text, SafeAreaView, Animated, Image, TouchableOpacity, ImageSourcePropType, Alert} from 'react-native'
            ...
            >
               <View className="flex flex-row items-center justify-between mt-5">
                ...
                <View className="flex flex-col mt-10">
                    <SettingsItem icon={icons.calendar} title="MyBookings" />
